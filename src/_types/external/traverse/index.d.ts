...
// Definitions by: Bazyli Brzóska <https://invent.life>, newclear <https://github.com/newclear>, Matt McFarland <http://github/mattmcfarland>
...
export interface StaticTraverse {
  /**
   * Get the element at the array `path`.
   */
