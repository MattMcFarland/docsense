...
declare namespace NPMLog {
  ...
  export function silly(prefix: string, ...message: any[]): void;
  export function verbose(prefix: string, ...message: any[]): void;
  export function info(prefix: string, ...message: any[]): void;
  export function http(prefix: string, ...message: any[]): void;
  export function warn(prefix: string, ...message: any[]): void;
  export function error(prefix: string, ...message: any[]): void;
